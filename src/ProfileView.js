...
function ProfileView({ navigation }) {
  ...
  const [editIconVisibility, setEditIcon] = useState(true);
          ...
          <>
            <View style={styles.avatarContainer}>
              <Image
                ...
                style={styles.avatar}
              />
              <TouchableOpacity style={[styles.editIconContainer, { display: editIconVisibility ? 'flex' : 'none' }]} onPress={handleEditProfilePicture}>                
